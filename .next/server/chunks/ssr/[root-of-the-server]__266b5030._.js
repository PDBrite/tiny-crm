...
"[project]/src/app/campaigns/select-leads/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SelectLeadsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchLeads = async ()=>{
            try {
                setLoading(true);
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('leads').select('id, first_name, last_name, email, phone, city, status, campaign_id, created_at, source').is('campaign_id', null) // Only leads not assigned to campaigns
                .order('created_at', {
                    ascending: false
                });
                if (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (searchTerm) {
            ...
            filtered = filtered.filter((lead)=>(lead.first_name || '').toLowerCase().includes(searchLower) || (lead.last_name || '').toLowerCase().includes(searchLower) || (lead.email || '').toLowerCase().includes(searchLower));
        }
        if (selectedStatus) {
    ...
    const handleCreateCampaign = async ()=>{
        ...
        try {
            // Create campaign
            const { data: campaign, error: campaignError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('campaigns').insert({
                name: campaignName,
        ...
        `).single();
            ...
            if (campaign.outreach_sequence?.steps) {
                ...
                const { error: touchpointsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('touchpoints').insert(touchpointsToCreate);
                if (touchpointsError) {
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                        ...
                                                        children: [
                                                            ...
                                                            availableStatuses.map((status)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: status,
                                                                    children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$leads$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STATUS_DISPLAY_MAP"][status]
                                                                }, status, false, {
                                                                    fileName: "[project]/src/app/campaigns/select-leads/page.tsx",
                                                                    lineNumber: 424,
                                                                    columnNumber: 23
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        ...
                                        children: (paginatedLeads || []).map((lead)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            ...
                                                            children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$leads$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STATUS_DISPLAY_MAP"][lead.status]
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/campaigns/select-leads/page.tsx",
                                                            lineNumber: 564,
                                                            columnNumber: 23
...
//# sourceMappingURL=%5Broot-of-the-server%5D__266b5030._.js.map