...
function Dashboard() {
    ...
    const [recentLeads, setRecentLeads] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [scheduledTouchpoints, setScheduledTouchpoints] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
            ...
            const fetchDashboardData = {
                "Dashboard.useEffect.fetchDashboardData": async ()=>{
                    try {
                        ...
                        const { data: campaignsData, error: campaignsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('campaigns').select('*').eq('company', selectedCompany);
                        if (campaignsError) {
                            console.error('Error fetching campaigns:', campaignsError);
                        // Continue with empty campaigns data
                        }
                        // Fetch leads for selected company campaigns
                        const campaignIds = campaignsData?.map({
                            "Dashboard.useEffect.fetchDashboardData": (c)=>c.id
                        }["Dashboard.useEffect.fetchDashboardData"]) || [];
                        let leadsData = null;
                        if (campaignIds.length > 0) {
                            const { data: fetchedLeadsData, error: leadsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('leads').select('*').in('campaign_id', campaignIds);
                            if (leadsError) {
                        ...
                        const leadIds = leadsData?.map({
                            "Dashboard.useEffect.fetchDashboardData": (l)=>l.id
                        }["Dashboard.useEffect.fetchDashboardData"]) || [];
                        let touchpointsData = [];
                        if (leadIds.length > 0) {
                            try {
                                const { data: fetchedTouchpointsData, error: touchpointsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('touchpoints').select('*').in('lead_id', leadIds);
                                if (touchpointsError) {
                        ...
                        const emailsMadeToday = touchpointsData?.filter({
                            "Dashboard.useEffect.fetchDashboardData": (t)=>t.type === 'email' && t.completed_at && new Date(t.completed_at) >= todayStart && new Date(t.completed_at) < todayEnd
                        }["Dashboard.useEffect.fetchDashboardData"]).length || 0;
                        const callsMadeToday = touchpointsData?.filter({
                            "Dashboard.useEffect.fetchDashboardData": (t)=>t.type === 'call' && t.completed_at && new Date(t.completed_at) >= todayStart && new Date(t.completed_at) < todayEnd
                        }["Dashboard.useEffect.fetchDashboardData"]).length || 0;
                        const activeLeads = leadsData?.filter({
                            "Dashboard.useEffect.fetchDashboardData": (l)=>![
                                    'won',
                                    'lost'
                                ].includes(l.status)
                        }["Dashboard.useEffect.fetchDashboardData"]).length || 0;
                        ...
                        const campaignStats = campaignsData?.map({
                            "Dashboard.useEffect.fetchDashboardData": (campaign)=>{
                                const campaignLeads = leadsData?.filter({
                                    "Dashboard.useEffect.fetchDashboardData": (l)=>l.campaign_id === campaign.id
                                }["Dashboard.useEffect.fetchDashboardData"]) || [];
                                const campaignLeadIds = campaignLeads.map({
                                    "Dashboard.useEffect.fetchDashboardData.campaignLeadIds": (l)=>l.id
                                }["Dashboard.useEffect.fetchDashboardData.campaignLeadIds"]);
                                const campaignTouchpoints = touchpointsData?.filter({
                                    "Dashboard.useEffect.fetchDashboardData": (t)=>campaignLeadIds.includes(t.lead_id)
                                }["Dashboard.useEffect.fetchDashboardData"]) || [];
                                return {
                                    ...campaign,
                                    lead_count: campaignLeads.length,
                                    email_count: campaignTouchpoints.filter({
                                        "Dashboard.useEffect.fetchDashboardData": (t)=>t.type === 'email'
                                    }["Dashboard.useEffect.fetchDashboardData"]).length,
                                    call_count: campaignTouchpoints.filter({
                                        "Dashboard.useEffect.fetchDashboardData": (t)=>t.type === 'call'
                                    }["Dashboard.useEffect.fetchDashboardData"]).length,
                                    conversion_count: campaignLeads.filter({
                                        "Dashboard.useEffect.fetchDashboardData": (l)=>l.status === 'won'
                                    }["Dashboard.useEffect.fetchDashboardData"]).length
                                };
                            }
                        }["Dashboard.useEffect.fetchDashboardData"]) || [];
                        ...
                        const sortedLeads = (leadsData || []).sort({
                            "Dashboard.useEffect.fetchDashboardData.sortedLeads": (a, b)=>new Date(b.created_at).getTime() - new Date(a.created_at).getTime()
                        }["Dashboard.useEffect.fetchDashboardData.sortedLeads"]).slice(0, 5);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-6",
                            children: scheduledTouchpoints.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: recentLeads.length > 0 ? recentLeads.map((lead, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: campaigns.length > 0 ? campaigns.map((campaign, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Dashboard, "H05+fMcrlfwgSLowlNaWWLEsi4Y=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$CompanyContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCompany"]
    ];
});
...
//# sourceMappingURL=src_e370f0aa._.js.map